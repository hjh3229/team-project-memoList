...
public class Memo {
    ...
    // 메모 내용 백업 (작성자 : 오세창 / 수정 취소 기능 구현을 해보려고, 한번 생성해봤습니다,,,)
    private String backupWriteMemo; // writeMemo 백업
    public String getBackupWriteMemo () {return backupWriteMemo;}
    ...
    public Memo(int memoNumber, String writerName, String password, String writedMemo, String writedTime) {
        ...
        this.password = password;
        this.writedMemo = writedMemo;
        this.backupWriteMemo = writedMemo;
    }
